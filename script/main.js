...
const messages = [
    ...
    "ini",
    "terakhir",
    "kannn aku mah ga boong",
    "aku ada pantun tauuu",
    "ga jadi, mau bilang sesuatu aja",
    "wopyuuuu pia❤️",
    "anjay hebat kan aku bisa buat ini",
    "coba pencet tombol dibawah ini bayiiii 💝"
];
